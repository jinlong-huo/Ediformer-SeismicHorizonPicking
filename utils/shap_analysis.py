...
# # Train a model basic sklearn foreast classifier
...
#         self.relu = nn.ReLU()
#         self.fc2 = nn.Linear(10, 2)  # 2 for binary classification
...
# with torch.no_grad():
#     model.eval()
#     y_pred_proba = torch.softmax(model(X_test_tensor), dim=1)[:, 1].numpy()
