...
class DexiNed(nn.Module):
    ...
    def forward(self, x): 
        ...
        # block_2_add shape [20, 128, 1, 72] here we can choose use scale layer or not
        ...
        block_4 = block_3_add + self.drop_path(self.attn(self.norm1(block_4_pre_dense)))
        ...
        block_5 = block_4_add + self.drop_path(self.attn(self.norm1(block_5_pre_dense)))
        block_5_add = block_5 + block_4_side

        # Block 6
        block_6_pre_dense = self.pre_dense_6(block_5)
        # block_6, _ = self.dblock_6([block_5_add, block_6_pre_dense])
        block_6 = block_5_add + self.drop_path(self.attn(self.norm1(block_6_pre_dense)))
