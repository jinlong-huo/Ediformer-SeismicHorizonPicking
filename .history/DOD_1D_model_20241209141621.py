...
class DexiNed(nn.Module):
    ...
    def forward(self, x): 
        ...
        # block_2_add shape [20, 128, 1, 72]
        block_3 = block_2_add + self.drop_path(self.layer_scale_1 * self.attn(self.norm1(block_3_pre_dense)))
        ...
        block_4 = block_3_add + self.drop_path(self.layer_scale_1 * self.attn(self.norm1(block_4_pre_dense)))
        ...
        block_5 = block_4_add + self.drop_path(self.layer_scale_1 * self.attn(self.norm1(block_5_pre_dense)))
        block_5_add = block_5 + block_4_side

        # Block 6
        block_6_pre_dense = self.pre_dense_6(block_5)
        # block_6, _ = self.dblock_6([block_5_add, block_6_pre_dense])
        block_6 = block_5_add + self.drop_path(self.layer_scale_1 * self.attn(self.norm1(block_6_pre_dense)))
...
if __name__ == '__main__':
    ...
    dim = 96
    heads = 2
    model = DexiNed(dim=dim, num_heads=heads).to(device)
    output = model(input)
