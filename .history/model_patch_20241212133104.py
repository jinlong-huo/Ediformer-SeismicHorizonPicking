...
class Mixer(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, attn_drop=0., proj_drop=0., attention_head=1, pool_size=2, 
        **kwargs, ):
        ...
        self.low_mixer = LowMixer(low_dim, num_heads=num_heads, qkv_bias=qkv_bias, attn_drop=attn_drop, pool_size=pool_size)
...
if __name__ == '__main__':
    batch_size = 2                                                                  
    img_height = 288    # 1   352
    img_width = 64   # 288 352
    ...
    embed_dims = [16, 36, 36, 36] # embed dim last dim
    heads = 2
