    ...
    def make_deconv_layers(self, in_features, up_scale):
        ...
        for i in range(up_scale):
            ...
            layers.append(nn.ConvTranspose2d(
                out_features, out_features, (2, kernel_size), stride=(2, 2), padding=(0, pad))) #gaile kernal_size
...
class Diformer(nn.Module):
    ...
    def __init__(self, dim, num_heads, qkv_bias=False, attn_drop=0., drop_path=0.,
                 ...
                 attn=Mixer, feature_projection_dim=32):
        ...
        # add maxpool2 to make the fourth block work well concerning the attention 
...
if __name__ == '__main__':
    ...
    model = Diformer(dim=[2, 1, 1, 1], num_heads=2)
    ...
    input_tensor = torch.randn(8, 1, 288, 8).to(device)  # Batch size 8, single channel 256x256 image
