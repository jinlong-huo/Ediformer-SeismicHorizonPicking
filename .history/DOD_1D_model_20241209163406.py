...
class Mixer(nn.Module):
    ...
    def forward(self, x):
        ...
        # hx3 shape 2 72 256 1   hx4 2 36 512 1 
        # lx3 shape 2 72 256 1    lx4 2 36 512 1
...
class DexiNed(nn.Module):
    ...
    def __init__(self, dim, num_heads, qkv_bias=False, attn_drop=0., drop_path=0.,
        ...
        self.up_block_5 = UpConvBlock(512, 2)
    ...
    def forward(self, x): 
        ...
        block_6_attn_dense = self.drop_path(self.attn3(self.norm4(block_6_pre_dense)))
...
if __name__ == '__main__':
    ...
    embed_dims = [72, 36, 36, 72] # embed dim last dim
    heads = 2
