...
class AdvancedEnsembleLearner:
    ...
    def train_ensemble(self, 
        ...
        for epoch in range(epochs):
            ...
            for (classifier, ((attr_name, train_loader), (attr_name, val_loader)), optimizer) in enumerate(zip(self.classifiers, zip(attribute_dataloaders, validation_dataloaders), classifier_optimizers)):
