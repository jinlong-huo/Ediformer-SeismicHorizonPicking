...
class AdvancedEnsembleLearner:
    ...
    def validate_fusion_model(self, validation_dataloaders, criterion, fm_path):
        stage_name = 'fusion'
        ...
        early_stopping(-val_loss, self.fusion_model, save_path, attr_name, stage_name='fusion')
    ...
    def train_ensemble(self, 
        ...
        for epoch in range(epochs):
            ...
            fusion_val_metrics = self.validate_fusion_model(validation_dataloaders, criterion,fm_path)
