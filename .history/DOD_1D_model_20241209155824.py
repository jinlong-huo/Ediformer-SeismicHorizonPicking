...
class Mixer(nn.Module):
    ...
    def forward(self, x):
        ...
        # hx3 shape 2 72 256 1   hx4 2 72 512 1 
        # lx shape 2 72 256 1
...
class DexiNed(nn.Module):
    ...
    def forward(self, x): 
        ...
        block_3_attn_dense = self.drop_path(self.attn(self.norm1(block_3_pre_dense)))
        ...
        block_4_attn_dense = self.drop_path(self.attn(self.norm2(block_4_pre_dense)))
        ...
        block_5_attn_dense = self.drop_path(self.attn(self.norm1(block_5_pre_dense)))
        ...
        block_6_attn_dense = self.drop_path(self.attn(self.norm(block_6_pre_dense)))
...
if __name__ == '__main__':
    ...
    embed_dims = [72, 36, 72, 72] # embed dim last dim
    heads = 2
