...
class DexiNed(nn.Module):
    ...
    def __init__(self, dim, num_heads, qkv_bias=False, attn_drop=0., drop_path=0.,
        ...
        self.attn1 = attn(dim[1], num_heads=num_heads, qkv_bias=qkv_bias, attn_drop=attn_drop, attention_head=attention_head, pool_size=pool_size,)
        
        self.attn1 = attn(dim[2], num_heads=num_heads, qkv_bias=qkv_bias, attn_drop=attn_drop, attention_head=attention_head, pool_size=pool_size,)
