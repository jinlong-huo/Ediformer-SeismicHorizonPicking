# Hint: 
# Basically, this is the trace-based diformer model, if you can't make it with the patch and attention integrated model, i.e., the diformer patch atten ones, you should try to use this model.
